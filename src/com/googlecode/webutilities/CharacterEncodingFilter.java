...
public class CharacterEncodingFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        this.force = "true".equalsIgnoreCase(filterConfig.getInitParameter("force"));
            ...
            if (encoding != null){
                ...
                if(force){
                    try{
                        ...
                        //failed to set encoding may be you have Servlet <= 2.3 (it doesn't have response.setCharacterEncoding)
                    }
                }
            }
        }
